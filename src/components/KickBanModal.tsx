...
const KickBanModal: React.FC<KickBanModalProps> = ({
  ...
  const [unbanTimeUnit, setUnbanTimeUnit] = useState<
      ...
      >
        ...
        >
          <Text style={[styles.title, { color: colors.text }]}>
            {mode === 'kick' ? 'Kick' : mode === 'ban' ? 'Ban' : 'Kick/Ban'}:{' '}
            {nick}
          </Text>
          ...
          <ScrollView
            ...
            style={styles.quickReasonsContainer}
          >
