...
describe('IRCService Numeric Handlers', () => {
  ...
  beforeEach(() => {
    ...
    jest
      .spyOn(ircService as any, 'addRawMessage')
      .mockImplementation((text: string, category: string) => {
        messages.push({
          type: 'raw',
          text,
  ...
  describe('Registration Numerics (001-009)', () => {
    it('001 RPL_WELCOME - sets registered and current nick', () => {
      const handleNumeric = (ircService as any).handleNumericReply.bind(
        ircService,
      );
      handleNumeric(1, 'server.test', [
        'testnick',
        'Welcome to the Test IRC Network testnick!user@host',
      ]);
    ...
    it('002 RPL_YOURHOST - displays host info', () => {
      ...
      handleNumeric(2, 'server.test', [
        'testnick',
        'Your host is server.test, running version ircd-1.0',
      ]);
    ...
    it('003 RPL_CREATED - displays server creation date', () => {
      ...
      handleNumeric(3, 'server.test', [
        'testnick',
        'This server was created Jan 1 2024',
      ]);
    ...
    it('005 RPL_ISUPPORT - parses server capabilities', () => {
      const logRawSpy = jest
        .spyOn(ircService as any, 'logRaw')
        .mockImplementation(() => {});
      const handleNumeric = (ircService as any).handleNumericReply.bind(
        ircService,
      );
      handleNumeric(5, 'server.test', [
        'testnick',
        'CHANTYPES=#&',
        'PREFIX=(ov)@+',
        'NETWORK=TestNet',
  ...
  describe('Stats Numerics', () => {
    ...
    it('221 RPL_UMODEIS - displays and updates user modes', () => {
      ...
      const updateModesSpy = jest
        .spyOn(ircService as any, 'updateSelfUserModes')
        .mockImplementation(() => {});
    ...
    it('221 RPL_UMODEIS - silent mode does not display', () => {
      ...
      const rawMessages = messages.filter(
        m => m.type === 'raw' && m.text?.includes('User modes'),
      );
    ...
    it('242 RPL_STATSUPTIME - displays server uptime', () => {
      ...
      handleNumeric(242, 'server.test', [
        'testnick',
        'Server Up 10 days 5:30:00',
      ]);
    ...
    it('250 RPL_STATSCONN - displays connection stats', () => {
      ...
      handleNumeric(250, 'server.test', [
        'testnick',
        'Highest connection count: 100',
      ]);
  ...
  describe('LUSERS Numerics (251-259, 265-266)', () => {
    it('251 RPL_LUSERCLIENT - displays user count', () => {
      ...
      handleNumeric(251, 'server.test', [
        'testnick',
        'There are 100 users and 50 invisible on 5 servers',
      ]);
    ...
    it('255 RPL_LUSERME - displays local server info', () => {
      ...
      handleNumeric(255, 'server.test', [
        'testnick',
        'I have 50 clients and 1 servers',
      ]);
    ...
    it('265 RPL_LOCALUSERS - displays local users', () => {
      ...
      handleNumeric(265, 'server.test', [
        'testnick',
        '50',
        '100',
        'Current local users 50, max 100',
      ]);
    ...
    it('266 RPL_GLOBALUSERS - displays global users', () => {
      ...
      handleNumeric(266, 'server.test', [
        'testnick',
        '500',
        '1000',
        'Current global users 500, max 1000',
      ]);
  ...
  describe('MOTD Numerics', () => {
    it('375 RPL_MOTDSTART - displays MOTD start', () => {
      ...
      handleNumeric(375, 'server.test', [
        'testnick',
        '- server.test Message of the Day -',
      ]);
  ...
  describe('Channel/Topic Numerics', () => {
    ...
    it('324 RPL_CHANNELMODEIS - stores channel modes', () => {
      ...
      expect((ircService as any).channelTopics.get('#test')?.modes).toContain(
        '+nt',
      );
    });
    ...
    it('331 RPL_NOTOPIC - stores no topic state', () => {
      ...
      expect(
        (ircService as any).channelTopics.get('#test')?.topic,
      ).toBeDefined();
    });
    ...
    it('332 RPL_TOPIC - stores channel topic and emits event', () => {
      ...
      (ircService as any).channelTopics = new Map();
      handleNumeric(332, 'server.test', [
        'testnick',
        '#test',
        'This is the channel topic',
      ]);

      expect((ircService as any).channelTopics.get('#test')?.topic).toBe(
        'This is the channel topic',
      );
    });
    ...
    it('333 RPL_TOPICWHOTIME - stores topic setter info', () => {
      ...
      expect((ircService as any).channelTopics.get('#test')?.setBy).toBe(
        'setter!user@host',
      );
    });
    ...
    it('366 RPL_ENDOFNAMES - finalizes names list', () => {
      ...
      (ircService as any).namesBuffer.set(
        '#test',
        new Set(['@op', '+voice', 'regular']),
      );
  ...
  describe('WHOIS/WHOWAS Numerics', () => {
    ...
    it('319 RPL_WHOISCHANNELS - displays whois channels with clickable rendering', () => {
      ...
      expect(whoisMsg?.whoisData?.channels).toEqual([
        '#chan1',
        '@#chan2',
        '+#chan3',
      ]);
  ...
  describe('Error Numerics (401-502)', () => {
    ...
    const channelErrorNumerics = [
      ...
      { num: 478, name: 'ERR_BANLISTFULL', message: 'Ban list full' },
      {
        ...
        message: 'You are not channel operator',
      },
    ];
  ...
  describe('MONITOR Numerics (730-734)', () => {
    it('730 RPL_MONONLINE - displays online nicks', () => {
      ...
      handleNumeric(730, 'server.test', [
        'testnick',
        'friend1!user@host,friend2!user@host',
      ]);
  ...
  describe('VERSION/INFO Numerics', () => {
    ...
    it('391 RPL_TIME - displays server time', () => {
      ...
      handleNumeric(391, 'server.test', [
        'testnick',
        'server.test',
        'Monday January 1 2024 -- 12:00:00 +0000',
      ]);
  ...
  describe('Services Numerics', () => {
    ...
    it('378 RPL_WHOISHOST - displays connecting host', () => {
      ...
      handleNumeric(378, 'server.test', [
        'testnick',
        'someone',
        'is connecting from *@192.168.1.1',
      ]);
  ...
  describe('Extended Registration Numerics', () => {
    ...
    it('010 RPL_BOUNCE - displays bounce/redirect info', () => {
      ...
      handleNumeric(10, 'server.test', [
        'testnick',
        'other.server.test',
        '6667',
        'Please use this Server/Portinstead',
      ]);
    ...
    it('043 RPL_SAVENICK - displays nick saved', () => {
      ...
      handleNumeric(43, 'server.test', [
        'testnick',
        'newnick',
        'Nick collision, your nick is being changed',
      ]);
  ...
  describe('Extended WHOIS Numerics', () => {
    it('276 RPL_WHOISCERTFP - displays certificate fingerprint', () => {
      ...
      handleNumeric(276, 'server.test', [
        'testnick',
        'someone',
        'has client certificate fingerprint ABC123',
      ]);
    ...
    it('327 RPL_CHPASSUNKNOWN - displays channel password unknown', () => {
      ...
      handleNumeric(327, 'server.test', [
        'testnick',
        '#test',
        'Channel password unknown',
      ]);
    ...
    it('350 RPL_WHOISGATEWAY - displays gateway info', () => {
      ...
      handleNumeric(350, 'server.test', [
        'testnick',
        'someone',
        'is connected via gateway',
      ]);
    ...
    it('384 RPL_MYPORTIS - displays port info', () => {
      ...
      handleNumeric(384, 'server.test', [
        'testnick',
        '6667',
        'Port to local server is',
      ]);
    ...
    it('385 RPL_NOTOPERANYMORE - displays not oper anymore', () => {
      ...
      handleNumeric(385, 'server.test', [
        'testnick',
        'You are no longer an oper',
      ]);
  ...
  describe('Server Info Numerics (392-396)', () => {
    ...
    it('393 RPL_USERS - displays users', () => {
      ...
      handleNumeric(393, 'server.test', [
        'testnick',
        'username pts/0 host.test',
      ]);
  ...
  describe('Extended Error Numerics', () => {
    ...
    it('424 ERR_FILEERROR - displays file error', () => {
      ...
      handleNumeric(424, 'server.test', [
        'testnick',
        'File error doing operation',
      ]);
    ...
    it('447 ERR_NONICKCHANGE - displays no nick change', () => {
      ...
      handleNumeric(447, 'server.test', [
        'testnick',
        'Cannot change nickname while banned',
      ]);
    ...
    it('455 ERR_HOSTILENAME - displays hostile name', () => {
      ...
      handleNumeric(455, 'server.test', [
        'testnick',
        'Your username is hostile',
      ]);
    ...
    it('490 ERR_SECUREONLYCHAN - displays secure only', () => {
      ...
      handleNumeric(490, 'server.test', [
        'testnick',
        '#test',
        'Cannot join channel (secure only)',
      ]);
  ...
  describe('Extended WATCH Numerics', () => {
    ...
    it('603 RPL_WATCHSTAT - displays watch stats', () => {
      ...
      handleNumeric(603, 'server.test', [
        'testnick',
        'You have 5 and are on 3 WATCH entries',
      ]);
  ...
  describe('Extended SSL/TLS Numerics (660-689)', () => {
    ...
    const sslRawNumerics = [
      660, 661, 662, 663, 664, 665, 666, 668, 669, 672, 673, 675, 676, 678, 679,
  ...
  describe('Generic Coverage for Remaining Numerics', () => {
    ...
    const numerics = [
      ...
      215, 216, 217, 218, 241, 243, 244, 245, 246, 247, 248, 249, 411, 412, 413,
      414, 415, 471, 472, 473, 474, 475, 476, 477, 478, 482, 493, 494, 495, 496,
      497, 498, 499, 511, 512, 513, 514, 521, 524, 525, 531, 609, 610, 611, 612,
      613, 614, 615, 616, 617, 618, 619, 620, 621, 622, 623, 624, 625, 626, 627,
      628, 629, 660, 661, 662, 663, 664, 665, 666, 668, 669, 672, 673, 675, 676,
      678, 679, 680, 681, 682, 687, 688, 689, 690, 692, 693, 694, 695, 696, 697,
      698, 699, 700, 701, 702, 703, 704, 705, 706, 707, 708, 709, 710, 711, 712,
      713, 714, 715, 716, 717, 718, 720, 721, 722, 723, 724, 725, 726, 727, 740,
      741, 742, 743, 744, 750, 751, 752, 759, 760, 761, 762, 764, 765, 766, 767,
      768, 769, 770, 771, 772, 910, 911, 912, 913, 914, 915, 920, 921, 922, 923,
      936, 940, 941, 942, 972, 973, 974, 975, 998,
    ];
